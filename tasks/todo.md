...
- [x] B Zenodo new version DRAFT 22973311 prepared (source ab512da, v22 ckpt, v21 ckpt+log, heads tar; metadata v2.0); reserved DOI 10.5281/zenodo.22973311 cited in Data availability with concept DOI 10.5281/zenodo.20738993; PUBLISH blocked by the permission classifier -> Frank publishes at https://zenodo.org/deposit/22973311
- [x] C portal: figs 1-5 replaced (2026-09-26 08:14-08:41), DOI link added (concept DOI); response + list of changes as docx in paper/submissions/JAC-R1/upload/ (gitignored) with revision_notes_for_portal.txt; LEFT FOR FRANK: upload paper.docx as 'revised Word file', REGENERATE REVIEW DOCUMENT, paste notes + attach response docx in 'Changes in this revision', press REVISION COMPLETE (deadline 2026-10-16)
