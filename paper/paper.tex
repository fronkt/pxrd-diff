...
Three recent generative approaches (DiffractGPT \footnote{Choudhary, K.
...
input-handicap artefact; it is exactly the gap a deliberately small
diagnostic model is expected to exhibit (§6).
...
archived at Zenodo (DOI: 10.5281/zenodo.20738994). The MP-20 dataset is
publicly available via the CDVAE benchmark. All experiments reproduce
from a single \texttt{requirements.txt} and the \texttt{scripts/}
